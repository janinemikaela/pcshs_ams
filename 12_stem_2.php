...
$subjectQuery = "SELECT * FROM 12_stem_2";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!empty($_POST['subject']) && !empty($_POST['teacher'])) {
        ...
        foreach ($subjects as $key => $subject) {
            ...
            // Assuming 'teacher_id' is the correct column name in the '12_stem_2' table
            $insertQuery = "INSERT INTO 12_stem_2 (subject, teacher) VALUES (?, ?)
        ...
        if (!empty($_POST['delete'])) {
            ...
            foreach ($deleteSubjects as $subject) {
                $deleteQuery = "DELETE FROM 12_stem_2 WHERE subject = ?";
            ...
            <script>
              ...
              function addSubjectRow() {
                ...
                function deleteRow(btn) {
                  ...
                  xhr.open("POST", "delete_stem122.php", true); // Point to delete.php
