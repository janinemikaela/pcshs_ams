...
$result = mysqli_query($mysqli, "SELECT * FROM 11_archimedes");

if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST['delete_btn'])) {
        $deleteId = $_POST['delete_id'];
        // Perform the delete query
        $deleteResult = mysqli_query($mysqli, "DELETE FROM 11_archimedes WHERE student_id = '$deleteId'");
...
<body>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-12 col-md-6">
                            <div class="card mb-3">
                                <div class="card-body">
                                    <div class="pt-4 pb-2">
                                        <h5 class="card-title">11 - Archimedes</h5>
                                    </div>
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#studentsTable').on('click', '[name="delete_btn"]', function () {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        // Do not reload here as DataTables will handle it
                    },
