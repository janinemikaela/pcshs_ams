              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    ...
                    <h5 class="card-title text-center pb-0 fs-4">Attendance Personnel</h5>
                  </div>

                  <form class="row g-3 needs-validation" novalidate>

                    <div class="col-12">
                      <input type="password" name="password" class="form-control" placeholder="Verification Code" id="password" required>
