...
$subjectQuery = "SELECT * FROM 11_abm_2";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!empty($_POST['subject']) && !empty($_POST['teacher'])) {
        ...
        foreach ($subjects as $key => $subject) {
            ...
            // Assuming 'teacher_id' is the correct column name in the '11_abm_2' table
            $insertQuery = "INSERT INTO 11_abm_2 (subject, teacher) VALUES (?, ?)
        ...
        if (!empty($_POST['delete'])) {
            ...
            foreach ($deleteSubjects as $subject) {
                $deleteQuery = "DELETE FROM 11_abm_2 WHERE subject = ?";
    ...
    <div class="col-lg-12">
      <div class="row">
        <div class="col-lg-12 col-md-6">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">11 - ABM (Second Semester)</h5>
            ...
            <script>
              ...
              function addSubjectRow() {
                ...
                function deleteRow(btn) {
                  ...
                  xhr.open("POST", "delete_abm112.php", true); // Point to delete.php
