...
if (isset($_POST['register_btn'])) {
    ...
    $user_check_query = "SELECT * FROM students WHERE student_id='$student_id' LIMIT 1";
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        $_SESSION['message'] = "Student ID already exists. Please choose a different Student ID.";
        ...
        $_SESSION['student_id_value'] = $student_id;
        ...
        if ($password == $con_password) {
            ...
            $sql = "INSERT INTO students (last_name, first_name, middle_name, student_id, birthday, sex, password, con_password) VALUES ('$last_name', '$first_name', '$middle_name', '$student_id', '$birthday', '$sex', '$password', '$con_password')";
            mysqli_query($db, $sql);
