...
$subjectQuery = "SELECT * FROM 12_abm_2";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!empty($_POST['subject']) && !empty($_POST['teacher'])) {
        ...
        foreach ($subjects as $key => $subject) {
            ...
            // Assuming 'teacher_id' is the correct column name in the '12_abm_2' table
            $insertQuery = "INSERT INTO 12_abm_2 (subject, teacher) VALUES (?, ?)
        ...
        if (!empty($_POST['delete'])) {
            ...
            foreach ($deleteSubjects as $subject) {
                $deleteQuery = "DELETE FROM 12_abm_2 WHERE subject = ?";
    ...
    <div class="col-lg-12">
      <div class="row">
        <div class="col-lg-12 col-md-6">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">12 - ABM (Second Semester)</h5>
            ...
            <script>
              ...
              function addSubjectRow() {
                ...
                function deleteRow(btn) {
                  ...
                  xhr.open("POST", "delete_abm122.php", true); // Point to delete.php
